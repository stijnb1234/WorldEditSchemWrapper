package nl.sbdeveloper.worldeditschemwrapper.we.we6;
...
public class WorldEditHandler_6 extends WorldEditInterface {
    public WorldEditHandler_6(WESInterface pluginInterface) {
